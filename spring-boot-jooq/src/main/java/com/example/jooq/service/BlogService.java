...
import static com.example.jooq.model.tables.Posts.POSTS;
import static com.example.jooq.model.tables.Comments.COMMENTS;
...
public class BlogService {
	...
	public Post createPost(Post post) {
		PostsRecord postsRecord = dsl.insertInto(POSTS)
				...
				.set(POSTS.CREATED_ON, post.getCreatedOn()).returning(POSTS.ID)
				.fetchOne();
